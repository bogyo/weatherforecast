...
import WeatherTime from './components/weathertime.js';
import WeatherTableInfo from './components/weathertableinfo.js';
import WeatherTableForecast from './components/weathertableforecast.js';
  ...
  constructor() {
    ...
    this.updateComponent = () => {
      ...
      WeatherService.getForecast(this.state.location).then(function(weatherlist){
        this.setState({weatherInfoToday: sorter.getTodayForecast(weatherlist)}, function(){ console.log('state today', this.state.weatherInfoToday)});

        this.setState({weatherForecast: sorter.getForecast(weatherlist)}, function(){ console.log('state forc', this.state.weatherForecast)});
    ...
    return(
      <div className="weather">
        <div className="weather-header">
          ...
          <p>Type the city name you are interested in  below </p>
        </div>
        <div className="weather-body">
          ...
          { this.state.time === 'Today' ?
            <WeatherTableInfo weatherInfoNow={this.state.weatherInfoNow} weatherInfoToday={this.state.weatherInfoToday}/>
